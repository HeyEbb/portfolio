  ...
  return (
    <>
      ...
      <main>
        ...
        <section>
          ...
          >
            ...
            <p>
              ...
              exhibit my skills and competencies to potential employers and
              clients. I envision this website as an invaluable tool for
              self-reflection, allowing me to assess my growth and evolution as
              both a designer and developer. <br />
              <br />
        ...
        `}
          >
            <h3 className="text-6xl">Im also pretty good at other stuff.</h3>
            <div className="grid grid-cols-1 justify-items-center gap-20 pt-10 md:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-4">
        ...
        <section className="flex flex-col ">
          ...
          <div className="m-3 grid h-screen min-h-[1200px] grid-cols-2 gap-2">
            ...
            >
              ...
              >
                ...
                <p className="text-white">
                  Nostrud non in eiusmod qui incididunt labore enim enim. Dolor
                  irure eiusmod et eiusmod Lorem minim exercitation occaecat
                  aliquip eiusmod adipisicing. Sint dolor ipsum aliqua culpa
                  proident occaecat voluptate ut consequat id pariatur
                  consectetur esse. Dolore sint minim magna nostrud qui pariatur
                  adipisicing quis laboris aliqua. Laborum nostrud cupidatat
                  veniam aliqua ad.
                </p>
              </div>
            </div>
            <div
              style={{
                backgroundImage: "url('/static/img/cms.jpg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
            ...
            <div
              style={{
                backgroundImage: "url('/static/img/react.jpg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
