  ...
  return (
    <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
      {projects.map((project, i) => (
        <div
          key={i}
          className="relative flex flex-col justify-end overflow-hidden rounded-lg p-8"
        >
          <div
            style={{
          ...
          <div className="flex h-full flex-col justify-between">
            <div>
              <div
                className={`${project.status === "Active Development" ? "bg-indigo-500" : "bg-gray-600"} relative z-10 mb-5 inline-block w-fit rounded-2xl px-4 py-1 font-semibold text-white`}
              >
                {project.status}
              </div>
